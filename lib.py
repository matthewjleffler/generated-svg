...
def punc_at(x, y) -> float:
  path("M{} {}q{} {} {} {}v{}q{} {} {} {}q{} {} {} {}v{}q{} {} {} {}v{}q{} {} {} {}q{} {} {} {}v{}q{} {} {} {}q{} {} {} {}"
    .format(x + let_h_quart, y,
            -let_h_quart, 0, -let_h_quart, -let_h_quart,
            -let_h_half,
            0, -let_h_quart, let_h_quart, -let_h_quart,
...
def punc_percent(x, y) -> float:
  ...
  circ(x + let_h_eight, y - let_h + let_h_eight, let_h_eight)
  circ(x + let_h_eight + let_h_quart, y - let_h_eight, let_h_eight)
  return let_h_half
...
def punc_dash(x, y) -> float:
  path("M{} {}h{}".format(x, y - let_h_half, let_h_half))
  return let_h_half

def punc_underscore(x, y) -> float:
  path("M{} {}h{}".format(x, y, let_h_half))
  return let_h_half
...
def punc_period(x, y) -> float:
  path("M{} {}v{}".format(x + let_h_quart, y, -let_h_eight))
  return let_h_half

def punc_slash(x, y) -> float:
  path("M{} {}l{} {}".format(x, y, let_h_half, -let_h))
  return let_h_half
...
def punc_single_quote(x, y) -> float:
  path("M{} {}v{}".format(x + let_h_quart, y - let_h + let_h_eight, let_h_eight))
  return let_h_half
